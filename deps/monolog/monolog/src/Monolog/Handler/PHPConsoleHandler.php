...
use HeurekaDeps\Monolog\Formatter\LineFormatter;
use HeurekaDeps\Monolog\Formatter\FormatterInterface;
use HeurekaDeps\Monolog\Logger;
use HeurekaDeps\Monolog\Utils;
use HeurekaDeps\PhpConsole\Connector;
use HeurekaDeps\PhpConsole\Handler as VendorPhpConsoleHandler;
use HeurekaDeps\PhpConsole\Helper;
/**
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    {
        if (!\class_exists('HeurekaDeps\\PhpConsole\\Connector')) {
