...
use HeurekaDeps\Elastic\Elasticsearch\Response\Elasticsearch;
use Throwable;
use RuntimeException;
use HeurekaDeps\Monolog\Logger;
use HeurekaDeps\Monolog\Formatter\FormatterInterface;
use HeurekaDeps\Monolog\Formatter\ElasticsearchFormatter;
use InvalidArgumentException;
use HeurekaDeps\Elasticsearch\Common\Exceptions\RuntimeException as ElasticsearchRuntimeException;
use HeurekaDeps\Elasticsearch\Client;
use HeurekaDeps\Elastic\Elasticsearch\Exception\InvalidArgumentException as ElasticInvalidArgumentException;
use HeurekaDeps\Elastic\Elasticsearch\Client as Client8;
/**
