 ...
 */
namespace HeurekaDeps\Monolog\Handler\FingersCrossed;
...
class ChannelLevelActivationStrategy implements ActivationStrategyInterface
{
    ...
    public function __construct($defaultActionLevel, array $channelToActionLevel = [])
    {
        ...
        $this->channelToActionLevel = \array_map('HeurekaDeps\\Monolog\\Logger::toMonologLevel', $channelToActionLevel);
    }
    /**
