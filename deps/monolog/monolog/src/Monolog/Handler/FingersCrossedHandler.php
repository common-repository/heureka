...
use HeurekaDeps\Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy;
use HeurekaDeps\Monolog\Handler\FingersCrossed\ActivationStrategyInterface;
use HeurekaDeps\Monolog\Logger;
use HeurekaDeps\Monolog\ResettableInterface;
