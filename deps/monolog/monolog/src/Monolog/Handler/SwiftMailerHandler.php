...
use HeurekaDeps\Swift_Message;
use HeurekaDeps\Swift;
/**
...
class SwiftMailerHandler extends MailHandler
{
     ...
     */
    public function __construct(\HeurekaDeps\Swift_Mailer $mailer, $message, $level = Logger::ERROR, bool $bubble = \true)
    {
