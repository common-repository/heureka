...
use HeurekaDeps\Elastica\Document;
use HeurekaDeps\Monolog\Formatter\FormatterInterface;
use HeurekaDeps\Monolog\Formatter\ElasticaFormatter;
use HeurekaDeps\Monolog\Logger;
use HeurekaDeps\Elastica\Client;
use HeurekaDeps\Elastica\Exception\ExceptionInterface;
/**
