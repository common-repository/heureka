...
namespace HeurekaDeps\Psr\Log\Test;

use HeurekaDeps\Psr\Log\LoggerInterface;
use HeurekaDeps\Psr\Log\LogLevel;
use HeurekaDeps\PHPUnit\Framework\TestCase;
/**
...
abstract class LoggerInterfaceTest extends TestCase
{
    ...
    {
        $this->assertInstanceOf('HeurekaDeps\\Psr\\Log\\LoggerInterface', $this->getLogger());
    }
    /**
    ...
    public function testObjectCastToString()
    {
        if (\method_exists($this, 'createPartialMock')) {
            $dummy = $this->createPartialMock('HeurekaDeps\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        } else {
            $dummy = $this->getMock('HeurekaDeps\\Psr\\Log\\Test\\DummyTest', array('__toString'));
        }
