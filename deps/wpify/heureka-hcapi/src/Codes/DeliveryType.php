...
class DeliveryType extends AbstractCodes
{
    ...
    {
        return [self::DELIVERY_TYPE_PERSONAL_PICKUP, self::DELIVERY_TYPE_CZECH_POST, self::DELIVERY_TYPE_PPL_DPD, self::DELIVERY_TYPE_EXPRESS, self::DELIVERY_TYPE_SPECIAL, self::DELIVERY_TYPE_CZECH_POST_SPECIAL, self::DELIVERY_TYPE_DEPOT_API];
    }
}
