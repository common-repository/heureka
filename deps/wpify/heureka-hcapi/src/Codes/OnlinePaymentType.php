...
class OnlinePaymentType extends AbstractCodes
{
    ...
    {
        return [self::PAYU_BANK_ACCOUNT, self::PAYU_CARD, self::PAYU_KOMERCNI_BANKA, self::PAYU_MBANK, self::PAYU_FIO, self::PAYU_GE_MONEY, self::PAYU_VOLKSBANK, self::PAYU_RAIFFEISEN, self::PAYU_CESKA_SPORITELNA, self::PAYU_CSOB, self::PAYU_ERA, self::PAYU_PAYSEC];
    }
}
