...
class OrderStatus extends AbstractCodes
{
    ...
    {
        return [self::STATUS_SHIPPED, self::STATUS_SENT_TO_SHOP, self::STATUS_PARTIALLY_COMPLETED, self::STATUS_SHOP_CONFIRMED, self::STATUS_CANCEL_SHOP, self::STATUS_CANCEL_CUSTOMER, self::STATUS_CANCEL_UNPAID, self::STATUS_RETURNED, self::STATUS_COMPLETED_ON_HEUREKA, self::STATUS_DELIVERED, self::STATUS_READY_FOR_PICKUP, self::STATUS_SHIPPED_TO_EXTERNAL_POINT];
    }
}
