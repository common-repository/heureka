...
use HeurekaDeps\Hcapi\Services\OrderStatus as OrderStatusService;
/**
...
class OrderStatus extends AbstractValidator
{
     ...
     * @var array
     */
    private $requiredItems = [OrderStatusService::KEY_ORDER, OrderStatusService::KEY_STATUS];
    /**
    ...
    {
        $this->orderStatusCodes = new \HeurekaDeps\Hcapi\Codes\OrderStatus();
    }
    /**
