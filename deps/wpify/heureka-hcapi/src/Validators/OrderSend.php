...
use HeurekaDeps\Hcapi\Services\OrderSend as OrderSendService;
/**
...
class OrderSend extends AbstractValidator
{
     ...
     * @var array
     */
    private $requiredItems = [OrderSendService::KEY_ORDER, OrderSendService::KEY_INTERNAL, OrderSendService::KEY_VS];
    /**
