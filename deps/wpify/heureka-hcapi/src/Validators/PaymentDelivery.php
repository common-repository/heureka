...
use HeurekaDeps\Hcapi\Services\PaymentDelivery as PaymentDeliveryService;
/**
...
class PaymentDelivery extends AbstractValidator
{
    ...
    {
        $this->deliveryTypeCodes = new \HeurekaDeps\Hcapi\Codes\DeliveryType();
        $this->storeTypeCodes = new \HeurekaDeps\Hcapi\Codes\StoreType();
        $this->paymentTypeCodes = new \HeurekaDeps\Hcapi\Codes\PaymentType();
    }
    /**
