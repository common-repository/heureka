...
namespace HeurekaDeps\Wpify\CustomFields\Implementations;

use HeurekaDeps\Automattic\WooCommerce\Admin\Overrides\Order;
use HeurekaDeps\Automattic\WooCommerce\Internal\DataStores\Orders\CustomOrdersTableController;
use WP_Post;
use WP_Screen;
...
class SubscriptionMetabox extends AbstractPostImplementation
{
    ...
    public function save($post_id)
    {
        ...
        if (\defined('HeurekaDeps\\DOING_AUTOSAVE') && DOING_AUTOSAVE) {
            return $post_id;
        }
