...
use HeurekaDeps\Heureka\ShopCertification\ApiEndpoint;
use HeurekaDeps\Heureka\ShopCertification\DuplicateProductItemIdException;
use HeurekaDeps\Heureka\ShopCertification\InvalidArgumentException;
use HeurekaDeps\Heureka\ShopCertification\IRequester;
use HeurekaDeps\Heureka\ShopCertification\Response;
/**
...
class ShopCertification
{
    ...
    public function setOrderId($orderId)
    {
        if (\strlen($orderId) > 255) {
            throw new InvalidArgumentException(\sprintf('OrderId must be a string limited to 255 characters, "%s" given.', \print_r($orderId, \true)));
        }
