...
namespace HeurekaDeps\DI\Proxy;

use HeurekaDeps\ProxyManager\Configuration;
use HeurekaDeps\ProxyManager\Factory\LazyLoadingValueHolderFactory;
use HeurekaDeps\ProxyManager\FileLocator\FileLocator;
use HeurekaDeps\ProxyManager\GeneratorStrategy\EvaluatingGeneratorStrategy;
use HeurekaDeps\ProxyManager\GeneratorStrategy\FileWriterGeneratorStrategy;
use HeurekaDeps\ProxyManager\Proxy\LazyLoadingInterface;
/**
