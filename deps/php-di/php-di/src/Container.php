...
use HeurekaDeps\DI\Definition\FactoryDefinition;
use HeurekaDeps\DI\Definition\Helper\DefinitionHelper;
use HeurekaDeps\DI\Definition\InstanceDefinition;
use HeurekaDeps\DI\Definition\ObjectDefinition;
use HeurekaDeps\DI\Definition\Resolver\DefinitionResolver;
use HeurekaDeps\DI\Definition\Resolver\ResolverDispatcher;
use HeurekaDeps\DI\Definition\Source\DefinitionArray;
use HeurekaDeps\DI\Definition\Source\MutableDefinitionSource;
use HeurekaDeps\DI\Definition\Source\ReflectionBasedAutowiring;
use HeurekaDeps\DI\Definition\Source\SourceChain;
use HeurekaDeps\DI\Definition\ValueDefinition;
use HeurekaDeps\DI\Invoker\DefinitionParameterResolver;
use HeurekaDeps\DI\Proxy\ProxyFactory;
use InvalidArgumentException;
use HeurekaDeps\Invoker\Invoker;
use HeurekaDeps\Invoker\InvokerInterface;
use HeurekaDeps\Invoker\ParameterResolver\AssociativeArrayResolver;
use HeurekaDeps\Invoker\ParameterResolver\Container\TypeHintContainerResolver;
use HeurekaDeps\Invoker\ParameterResolver\DefaultValueResolver;
use HeurekaDeps\Invoker\ParameterResolver\NumericArrayResolver;
use HeurekaDeps\Invoker\ParameterResolver\ResolverChain;
