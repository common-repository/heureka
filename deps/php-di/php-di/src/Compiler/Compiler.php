...
namespace HeurekaDeps\DI\Compiler;

use function chmod;
use HeurekaDeps\DI\Definition\ArrayDefinition;
use HeurekaDeps\DI\Definition\DecoratorDefinition;
...
use HeurekaDeps\DI\Definition\Source\DefinitionSource;
